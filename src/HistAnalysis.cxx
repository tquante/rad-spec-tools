...
TF1* HistAnalysis::fitPeaks(TH1 *hist, TSpectrum *spectrum,double sigma, Option_t* option, Option_t* goption, bool enableSkew, const char* bgModel) {
...
TF1* HistAnalysis::findAndFitPeaks(TH1 *hist, Option_t* option, Option_t* goption, double sigma, double threshold, bool enableSkew, const char* bgModel) {
	...
	TF1 *sdpeaks = fitPeaks(hist, spectrum,sigma, option, goption, enableSkew, bgModel);
	delete spectrum;
	return sdpeaks;
}
